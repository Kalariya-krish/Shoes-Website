        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="col-sm-12 col-lg-6 col-md-6 col-12 col-xxl-6 border border-2 p-2">
                    ...
                    <!-- size -->
                    <div class="p-2">
                        <a href="{{ URL::to('/') }}/user_set_size6/{{ $data['Pro_id'] }}"><button class="btn btn-dark">6</button></a>
                        <a href="{{ URL::to('/') }}/user_set_size7/{{ $data['Pro_id'] }}"><button class="btn btn-dark">7</button></a>
                        <a href="{{ URL::to('/') }}/user_set_size8/{{ $data['Pro_id'] }}"><button class="btn btn-dark">8</button></a>
                        <a href="{{ URL::to('/') }}/user_set_size9/{{ $data['Pro_id'] }}"><button class="btn btn-dark">9</button></a>
                        <a href="{{ URL::to('/') }}/user_set_size10/{{ $data['Pro_id'] }}"><button class="btn btn-dark">10</button></a>
                    </div>
                    <div class="row" style="justify-content:center; align-items:center; padding:30px 10px;">
                        <div class="col-4">
                            <a href="{{ URl::to('/') }}/user_add_to_cart/{{ $data['Pro_id'] }}"><button
