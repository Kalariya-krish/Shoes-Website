...
<head>
    ...
    <link rel="apple-touch-icon" href="images/apple-toucsh-icon.png">
</head>
...
<body>
    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            @foreach ($data as $r)
            <li class="text-left">
                <img src="{{ URL::to('/') }}/images/slider/{{ $r['Image'] }}" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="{{ URL::to('/') }}/images/blog/{{ $b['Image'] }}" alt="" />
                        </div>
